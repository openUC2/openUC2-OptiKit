...
| — | next: WP-42 → WP-43 (round 5), then WP-37 (light polish + View-3D retirement); WP-27 (tutorials) after; WP-26 (motor/firmware actuation) folds into WP-42's contract; FRAME UX rework still needs a spec conversation | ⬜ |
