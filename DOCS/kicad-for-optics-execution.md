...
| — | next: WP-20 (Inventor datum contract, Bene async); package + send the E2 schema asks to Ethan; review the 315 migrated `openuc2.*` records; FRAME UX rework still needs a spec conversation | ⬜ |
