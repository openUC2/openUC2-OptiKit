...
| — | next: WP-43 (CSV palette → library), then WP-37 (light polish + View-3D retirement); WP-27 (tutorials) after; WP-26 (motor/firmware actuation) is now WP-42's contract with a real actuator; FRAME UX rework still needs a spec conversation | ⬜ |
